  ...
  return (
    <footer>
      <ul className={style["footer__link"]}>
        <li>
          <a
            className={style["footer__link--repo"]}
            href="https://github.com/OkapiAndromede"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span>GitHub</span>
            <svg
              className={style["footer__link--gitLogo"]}
        ...
        <li>
          <NavLink className={style["footer__link--mail"]} to={"/contact"}>
            <span>Contact</span>
            <svg
              className={style["footer__link--mailLogo"]}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
            >
